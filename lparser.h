...
typedef struct expdesc {
  expkind k;
  union {
    lau_Integer ival;    /* for VKINT */
    lau_Number nval;  /* for VKFLT */
...
LAUI_FUNC lu_byte lauY_nvarstack (FuncState *fs);
LAUI_FUNC void lauY_checklimit (FuncState *fs, int v, int l,
                                const char *what);
LAUI_FUNC LClosure *lauY_parser (lau_State *L, ZIO *z, Table *anchor,
